...
export default function Home({ notionWorkTasks, notionOrganizers }: any) {
  ...
  return (
    <>
      ...
      <header className="relative bg-blue-500 py-40 px-4 text-center">
        <svg
      ...
      <svg
        className="-z-10 -translate-y-9 fill-blue-500 sm:-translate-y-16 lg:-translate-y-20 xl:-translate-y-28 2xl:-translate-y-36"
        xmlns="http://www.w3.org/2000/svg"
